...
/** Requête HTTPS brute (auto-signé accepté), renvoie {statut, enTetes, corps, protocoleTls}. */
function requeteHttps(chemin, enTetes = {}) {
  return new Promise((resoudre, rejeter) => {
    const requete = https.request({
      ...
      // Le protocole TLS se lit À LA RÉCEPTION : à l'événement `end`, le
      // socket est déjà détaché de la réponse (null sous Node 24).
