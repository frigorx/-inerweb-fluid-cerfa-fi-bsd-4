...
// DÉPENDANCES : aucune. ⚠ CLONE EN LITTÉRAL de v8/js/data/export-personne.js
...
const VERSION_EXPORT_PERSONNE = 1;
 ...
 */
function assemblerExportPersonne(personneId, sources, genereLe) {
  const s = sources || {};
...
module.exports = { assemblerExportPersonne, VERSION_EXPORT_PERSONNE };
