...
139 exécutions ». Cette phrase ne veut pas dire ce qu'elle a l'air de dire, et la
...
Le dépôt affiche « tout vert, 139 exécutions » (chiffre de `docs/CARTE-CODE.md:35`).
**Ce chiffre a été rejoué le 27/07/2026 après le lot 0**, par
`node outils/lancer-tests.mjs --tout` : résultat « TOUT VERT — 139 exécutions ».
...
- Le filet de tests **a été rejoué** le 27/07/2026, après le lot 0
  (`node outils/lancer-tests.mjs --tout` → « TOUT VERT — 139 exécutions », durée de l'ordre
