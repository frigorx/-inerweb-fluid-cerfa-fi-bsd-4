...
apparaissent dans le journal du dépôt — **A02 à A07, A14, A18, A23** — parce que ce sont les seuls
qui ont donné lieu à un correctif ou à un désaccord écrit ; on les trouve dans les messages de
commit, dans `CHANGELOG.md` et dans `docs/PROMPT-REPRISE.md`. Les autres n'y figurent pas, faute
...
| **P0-02** | Formation et officiel partagent les mêmes stocks et bilans | A02 | **DÉSACCORD DE FOND, argumenté, non corrigé.** Un résidu de présentation qu'il contenait a été corrigé (§3.6). | §3 |
...
| **P0-08** | La livraison finale n'est pas reproductible ni certifiable avec ce paquet | A10 | **CONFIRMÉ, et corrigé dans l'envoi lui-même** : ce paquet-ci joint une **archive exécutable** du dépôt, bibliothèques tierces et gabarit CERFA compris. Le SBOM formel et la recette sur poste cible restent à produire. | §7, annexe |
...
| **§3** | *(relevé par nous, pas par le rapport)* comptages inexacts | A31 | Le rapport annonce « 32 migrations » là où le registre allait jusqu'au **n° 35** (soit 34 migrations, numérotées de 2 à 35) ; en revanche il a **raison** sur le nombre de lignes du dispatcher, et c'est nous qui nous étions trompés. | §7 |
