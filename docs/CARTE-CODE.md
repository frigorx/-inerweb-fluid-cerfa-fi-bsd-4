...
| Module | Rôle |
|---|---|
| `contrat.js` | LA vérité de surface : 87 méthodes documentées, messages canoniques (`VERSION_CONTRAT` 13 depuis le lot B2 : `bordereauExterne` sur le suivi de remise en filière) |
