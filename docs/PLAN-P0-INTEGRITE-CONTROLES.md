...
3. **P0-7, en briques, Opus effort xhigh, petites étapes :**
   ...
   - **P7-d2** — wizard : carte « Contrôle d'étanchéité » à l'étape 1 + parcours « sec » (pas de bouteille/pesées, résultat obligatoire, reprise CR-1, récap) ; vérif navigateur port jetable.
