...
export function redigerSommaire(titre, lignesInfos, nomsFichiers, maintenant) {
  ...
  return [
    ...
    'Vérifier le mode de chaque écriture ; FORMATION ne justifie pas une intervention réelle.',
    'Les empreintes vérifient une intégrité technique, pas l’exactitude des faits ni l’identité.',
    '',
    'CONTENU DU DOSSIER',
    '-'.repeat(68),
