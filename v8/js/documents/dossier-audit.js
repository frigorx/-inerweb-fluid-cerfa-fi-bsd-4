...
function redigerSommaire(etablissement, annee, nomsFichiers, maintenant) {
  ...
  const lignes = [
    ...
    'DOSSIER DE SUIVI — NE CERTIFIE PAS LA CONFORMITÉ.',
    'Lire le mode de chaque écriture : FORMATION ne justifie pas une intervention réelle.',
    'Une empreinte SHA-256 ne certifie ni l’exactitude métier ni l’identité des signataires.',
    '',
    'CONTENU DU DOSSIER',
    '-'.repeat(68),
    ...
    '15497*04 remplies sur le formulaire officiel ; leur statut dépend du mode (mouvements et',
