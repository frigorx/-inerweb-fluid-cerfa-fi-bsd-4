...
// surface (73 méthodes, 2 propriétés, rien de plus), sémantique
...
// ============================================================
// 1. Surface du contrat : 73 méthodes, 2 propriétés, rien de plus
// ============================================================
...
verifier('le contrat compte bien 73 méthodes',
  Object.keys(METHODES_CONTRAT).length === 73,
...
const LECTURES_SANS_ARGUMENT = [
  ...
  'getSentinelle', 'getHabilitations'
];
{
