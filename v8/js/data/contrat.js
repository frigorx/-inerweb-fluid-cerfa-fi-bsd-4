...
export const METHODES_CONTRAT = {
  ...
  getSignaturesMouvement: { genre: 'lecture',
    description: 'Les signatures réelles d’un mouvement (id) : [{ id, mouvementId, role, nom, prenom, qualite, organisation, parDelegation, dateHeure ISO, declaration, imagePng, sessionCompteId, sessionPersonnelId, sha256Document, versionDocument, valide }] — valide = versionDocument égale la révision courante du brouillon ET image recevable (lot B3, revue du 25/07 : une image illisible entrée par un import ne vaut PAS signature — les conditions 14/15 du mode Officiel restent alors opposées) ; tri dateHeure puis id (comparaison de chaînes simple) ; copies indépendantes ; Error si mouvement introuvable.' },
