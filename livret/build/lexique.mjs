...
export const LEXIQUE = {
  'lexique-1': {
    ...
    entrees: [
      ...
      ['Surchauffe', 'Les degrés gagnés par la vapeur au-delà du point où elle est devenue entièrement vapeur. On la mesure côté aspiration, avec un manomètre ET un thermomètre. Plage usuelle : 5 à 10 K.'],
      ['Sous-refroidissement', 'Les degrés perdus par le liquide en dessous du point où il est devenu entièrement liquide. Il garantit du liquide pur au détendeur. Plage usuelle : 4 à 8 K.'],
  ...
  'lexique-3': {
    ...
    entrees: [
      ...
      ['Catégories A1, A2, D, E', 'A1 : toutes les activités, sans limite de charge. A2 : les mêmes, sur les équipements de faible charge. D : la récupération seule. E : le contrôle d’étanchéité, sans accéder au circuit.'],
