...
export const CHAPITRES = [
  ...
  },
  {
    ...
    lecons: [
      { t: 'Deux lettres, deux dangers', src: 'cl1', paras: 'tous', blocs: [0],
        visuels: ['svg:classes-securite', 'sym:manometres'],
        legendes: ['La matrice NF EN 378', 'Ce qu on lit sur la machine'] },
      { t: 'Le piège du R-290', src: 'cl1', paras: 'tous', blocs: [1],
      ...
      { t: 'CO₂ : la pression et l air qu il vous prend', src: 'cl3', paras: 'tous', blocs: [0, 1],
  ...
  },
  {
    ...
    codesQ: ['1.02', '5.05'],
    lecons: [
      { t: 'Deux mesures, deux extrémités du circuit', src: 'g1e', paras: 'tous', blocs: [0],
        visuels: ['svg:mesure-surchauffe', 'illu:g1e'],
        legendes: ['Les deux points de mesure', 'Ce que la valeur vous dit'] },
      { t: 'Une surchauffe ne se lit pas sur un thermomètre', src: 'g1e', paras: 'tous', blocs: [1],
  ...
  },
  {
    ...
    lecons: [
      { t: 'Le code dit la molécule', src: 'g1c', paras: 'tous', blocs: [0],
        visuels: ['svg:familles-fluides', 'illu:g1c'],
        legendes: ['Les familles', 'L astuce du + 90'] },
      { t: 'Le code ne dit pas le danger', src: 'g1c', paras: 'tous', blocs: [1, 2],
        visuels: ['svg:classes-securite', 'svg:prp-echelle'],
  ...
  /* =================== PARTIE D — LES ORGANES =================== */
  {
    ...
    groupesQ: ['G6'],
    lecons: [
      { t: 'Ce qu il fait, et où il fuit', src: 'g6', paras: 'tous', blocs: [],
        visuels: ['svg:compresseurs', 'illu:g6'],
        legendes: ['La coupe animée', 'Les technologies'] },
      { t: 'Ce que dit une température de refoulement', src: 'g6', paras: 'tous', blocs: [0, 1],
        visuels: ['sym:compresseur_piston', 'sym:compresseur_scroll'],
        legendes: ['Piston', 'Scroll'] },
      { t: 'L huile, et le rapport d état', src: 'g6', paras: 'tous', blocs: [2],
        visuels: ['sym:separateur_huile', 'illu:g6'],
        legendes: ['Le séparateur d huile', 'Ce que le rapport contient'] },
      { t: 'Installer sans fuite, régler les sécurités', src: 'g6b', paras: 'tous', blocs: [0, 1],
  ...
  },
  {
    ...
    groupesQ: ['G7'],
    lecons: [
      { t: 'Ce qu il fait, et où il fuit', src: 'g7', codes: ['7.01', '7.08'], paras: 'tous', blocs: [1],
        visuels: ['svg:condenseur-trois-zones', 'illu:g7'],
        legendes: ['Désurchauffe, condensation, sous-refroidissement', 'Le condenseur'] },
      { t: 'Deux pressostats, deux fonctions', src: 'g7', codes: ['7.04'], paras: 'tous', blocs: [0],
        visuels: ['sym:pressostat_hp', 'sym:ventilateur'],
        legendes: ['Sécurité haute pression', 'Régulation par le ventilateur'] },
      { t: 'Installer l unité extérieure, régler la pression', src: 'g7b', codes: ['7.03', '7.02'], paras: 'tous', blocs: [0, 1],
        visuels: ['sym:echangeur_a_air', 'illu:g7b'],
        legendes: ['L échangeur à air', 'Le régulateur de pression'] },
      { t: 'Un régulateur ne coupe rien', src: 'g7b', codes: ['7.02', '7.05'], paras: 'tous', blocs: [2, 3],
        visuels: ['svg:regulateurs-pression', 'sym:vanne_securite'],
        legendes: ['Réguler n est pas protéger', 'La soupape, elle, coupe'] },
      { t: 'Purger, mesurer, rendre compte', src: 'g7b', codes: ['7.06', '7.07', '7.09', '7.10'], paras: 'tous', blocs: [4, 5, 6],
  ...
  },
  {
    ...
    groupesQ: ['G8'],
    lecons: [
      { t: 'Ce qu il fait, et où il fuit', src: 'g8', codes: ['8.01', '8.09'], paras: 'tous', blocs: [],
        visuels: ['svg:mesure-surchauffe', 'illu:g8'],
        legendes: ['Les points de mesure', 'L évaporateur'] },
      { t: 'Lire la surchauffe, et les deux organes qu on confond', src: 'g8', codes: ['8.05', '8.07'], paras: 'tous', blocs: [0, 1, 2],
        visuels: ['sym:detendeur_thermo_ext', 'sym:pressostat_bp'],
        legendes: ['Le détendeur thermostatique', 'Le pressostat BP'] },
      { t: 'Le givre et le dégivrage', src: 'g8b', codes: ['8.06'], paras: 'tous', blocs: [0],
        visuels: ['svg:givre-degivrage', 'sym:resistance_evaporation'],
        legendes: ['Pourquoi le givre isole', 'La résistance de dégivrage'] },
      { t: 'Qui protège quoi', src: 'g8b', codes: ['8.02', '8.04'], paras: 'tous', blocs: [1],
        visuels: ['sym:thermostat_froid', 'illu:g8b'],
        legendes: ['Le thermostat régule', 'Les sécurités'] },
      { t: 'Démarrer, mesurer, rendre compte', src: 'g8b', codes: ['8.03', '8.08', '8.10', '8.11'], paras: 'tous', blocs: [2],
  ...
  },
  {
    ...
    lecons: [
      ...
      { t: 'Sécurité électrique, sécurité mécanique', src: 'g9', paras: 'tous', blocs: [0, 1],
        visuels: ['sym:detendeur_electronique', 'sym:electrovanne_frigo'],
        legendes: ['Le détendeur électronique', 'L électrovanne'] },
      { t: 'La ligne liquide, organe par organe', src: 'g9b', paras: 'tous', blocs: [],
        visuels: ['svg:regulateurs-kv-places', 'sym:filtre_deshydrateur'],
        legendes: ['Chaque régulateur à sa place', 'Le filtre déshydrateur'] },
      { t: 'Un bon réglage, c est de l énergie économisée', src: 'g9b', paras: 'tous', blocs: [0],
  ...
  /* =================== PARTIE E — LES OPÉRATIONS =================== */
  {
    ...
    groupesQ: ['G3'],
    lecons: [
      { t: 'Deux épreuves, deux buts', src: 'g3', paras: 'tous', blocs: [0],
      ...
      { t: 'Le vide qui remonte, et la fuite qu on localise', src: 'g3', paras: 'tous', blocs: [1, 2],
  ...
  },
  {
    ...
    groupesQ: ['G4'],
    lecons: [
      { t: 'Où fuit une installation', src: 'g4a', codes: ['4.01', '4.03'], paras: 'tous', blocs: [0],
        visuels: ['svg:points-de-fuite', 'illu:g4a'],
        legendes: ['Six familles de points', 'L ordre ne s invente pas'] },
      { t: 'Consulter le registre avant de commencer', src: 'g4a', codes: ['4.02', '4.09'], paras: 'tous', blocs: [1],
        visuels: ['sym:vanne_isolement', 'illu:g4a'],
        legendes: ['La trace d huile', 'Ce que le registre dit déjà'] },
      { t: 'Méthode indirecte — mesurer et interpréter', src: 'g4b', codes: ['4.04', '4.05'], paras: 'tous', blocs: [0, 1, 2],
        visuels: ['svg:lecture-table', 'illu:g4b'],
        legendes: ['La lecture croisée', 'Trois instruments'] },
      { t: 'Méthode directe — le détecteur', src: 'g4c', codes: ['4.06', '4.07'], paras: 'tous', blocs: [0],
        visuels: ['svg:balayage-detecteur', 'illu:g4c'],
        legendes: ['La sonde balaie le raccord', 'Une alerte se confirme'] },
      { t: 'L instrument aussi se contrôle, et le registre se remplit', src: 'g4c', codes: ['4.08', '4.09'], paras: 'tous', blocs: [1],
        visuels: ['svg:balayage-detecteur', 'illu:g4c'],
  ...
  },
  {
    ...
    groupesQ: ['G5'],
    lecons: [
      { t: 'Récupérer sans émettre', src: 'g5a', paras: 'tous', blocs: [0],
  ...
  },
  {
    ...
    groupesQ: ['G10', 'G3'],
    lecons: [
      { t: 'Deux opérations à l azote, à ne pas confondre', src: 'g10', paras: 'tous', blocs: [0],
        visuels: ['svg:balayage-azote', 'illu:g10'],
        legendes: ['Le balayage pendant le brasage', 'Balayer n est pas éprouver'] },
      { t: 'Ce que la flamme fabrique sans azote', src: 'g10', paras: 'tous', blocs: [],
        visuels: ['svg:secu-flamme', 'svg:secu-decomposition-ari'],
        legendes: ['La flamme et le fluide', 'Ce qui se décompose'] },
      { t: 'Le support compte autant que le joint', src: 'g10', paras: 'tous', blocs: [1],
        visuels: ['svg:balayage-azote', 'illu:g10'],
  ...
  /* =================== PARTIE F — RISQUE ET AVENIR =================== */
  {
    ...
    groupesQ: ['G11'],
    lecons: [
      { t: 'Par quoi remplacer, et ce que la classe impose', src: 'g11', codes: ['11.01', '1.08', '11.03'], paras: 'tous', blocs: [0, 1],
        visuels: ['svg:familles-fluides', 'illu:g11'],
        legendes: ['Les candidats', 'Le piège de l année'] },
      { t: 'Ce qui fait consommer une installation', src: 'g11', codes: ['11.02'], paras: 'tous', blocs: [2],
      ...
      { t: 'Moins de fluide dans la machine, et le cas des hydrocarbures', src: 'g11', codes: ['11.02', '11.04', '11.05'], paras: 'tous', blocs: [3],
  ...
  },
  {
    ...
    groupesQ: ['G12'],
    lecons: [
      { t: 'Étiquetage et deux confusions qui coûtent cher', src: 'g12', codes: ['12.01', '12.02'], paras: 'tous', blocs: [0],
        visuels: ['svg:classes-securite', 'illu:g12'],
        legendes: ['A3, jamais A2L', 'L étiquetage'] },
      { t: 'Avant toute flamme', src: 'g12', codes: ['12.04', '12.05', '12.13'], paras: 'tous', blocs: [1],
        visuels: ['svg:lie-domaine', 'svg:secu-flamme'],
        legendes: ['Le domaine d explosivité', 'La flamme interdite'] },
      { t: 'Charge maximale : jamais estimée', src: 'g12', codes: ['12.03', '12.14'], paras: 'tous', blocs: [2],
        visuels: ['svg:charge-limite-local', 'illu:g12'],
        legendes: ['Elle se calcule', 'Selon la surface du local'] },
      { t: 'Récupérer et remplir à l azote', src: 'g12b', codes: ['12.06', '12.07', '12.08', '12.09'], paras: 'tous', blocs: [0],
        visuels: ['svg:recuperation', 'svg:epreuve-azote'],
        legendes: ['La récupération', 'Le remplissage à l azote'] },
      { t: 'Le fil rouge de l intervention', src: 'g12b', codes: ['12.10', '12.11', '12.12'], paras: 'tous', blocs: [1],
  ...
  },
  {
    ...
    groupesQ: ['G13'],
    lecons: [
      { t: '« A1 » ne veut pas dire « sans danger »', src: 'g13', paras: 'tous', blocs: [0],
        visuels: ['svg:co2-nh3-compare', 'illu:g13'],
        legendes: ['Deux fluides, deux dangers', 'Le CO₂ et l ammoniac'] },
      { t: 'La règle des catégories', src: 'g13', paras: 'tous', blocs: [1],
        visuels: ['svg:aptitude-capacite', 'illu:g13'],
        legendes: ['B pour le CO₂, C pour l ammoniac', 'Aucune équivalence'] },
      { t: 'La glace carbonique, et le réflexe d arrivée sur site', src: 'g13', paras: 'tous', blocs: [2, 3],
...
export const LIMINAIRES = [
  ...
  { id: 'avant-propos', t: 'Avant-propos', visuels: ['amb:jour1'], legendes: ['Le métier change, les fondamentaux restent'] },
