...
export const CHAPITRES = [
  ...
  /* =================== PARTIE C — SAVOIR =================== */
  {
    ...
    lecons: [
      { t: 'La croix du frigoriste', src: 'g1a', paras: 'tous', blocs: [0],
        ...
        legendes: ['Détendeur à gauche, compresseur à droite', 'Ce que le manomètre donne à lire'] },
  ...
  },
  {
    ...
    groupesQ: ['G7'],
    lecons: [
      { t: 'Ce qu il fait, et où il fuit', src: 'g7', paras: 'tous', blocs: [1],
        visuels: ['svg:condenseur-trois-zones', 'illu:g7'],
        legendes: ['Désurchauffe, condensation, sous-refroidissement', 'Le condenseur'] },
      { t: 'Deux pressostats, deux fonctions', src: 'g7', paras: 'tous', blocs: [0],
        visuels: ['sym:pressostat_hp', 'sym:ventilateur'],
        legendes: ['Sécurité haute pression', 'Régulation par le ventilateur'] },
      { t: 'Installer l unité extérieure, régler la pression', src: 'g7b', paras: 'tous', blocs: [0, 1],
        visuels: ['sym:echangeur_a_air', 'illu:g7b'],
        legendes: ['L échangeur à air', 'Redresser les ailettes, rétablir l échange'] },
      { t: 'Un régulateur ne coupe rien', src: 'g7b', paras: 'tous', blocs: [2, 3],
        visuels: ['svg:regulateurs-pression', 'sym:vanne_securite'],
        legendes: ['Réguler n est pas protéger', 'La soupape, elle, coupe'] },
      { t: 'Purger, mesurer, rendre compte', src: 'g7b', paras: 'tous', blocs: [4, 5, 6],
  ...
  },
  {
    ...
    groupesQ: ['G8'],
    lecons: [
      { t: 'Ce qu il fait, et où il fuit', src: 'g8', paras: 'tous', blocs: [],
        visuels: ['svg:mesure-surchauffe', 'illu:g8'],
        legendes: ['Les points de mesure', 'L évaporateur'] },
      { t: 'Lire la surchauffe, et les deux organes qu on confond', src: 'g8', paras: 'tous', blocs: [0, 1, 2],
        visuels: ['sym:detendeur_thermo_ext', 'sym:pressostat_bp'],
        legendes: ['Le détendeur thermostatique', 'Le pressostat BP'] },
      { t: 'Le givre et le dégivrage', src: 'g8b', paras: 'tous', blocs: [0],
        visuels: ['svg:givre-degivrage', 'sym:resistance_evaporation'],
        legendes: ['Pourquoi le givre isole', 'La résistance de dégivrage'] },
      { t: 'Qui protège quoi', src: 'g8b', paras: 'tous', blocs: [1],
        visuels: ['sym:thermostat_froid', 'illu:g8b'],
        legendes: ['Le thermostat régule', 'Le givre isole la batterie'] },
      { t: 'Démarrer, mesurer, rendre compte', src: 'g8b', paras: 'tous', blocs: [2],
  ...
  /* =================== PARTIE E — LES OPÉRATIONS =================== */
  {
    ...
    lecons: [
      ...
      { t: 'Pompe à vide et vacuomètre', src: 'p3', paras: 'tous', blocs: [0, 1],
        ...
        legendes: ['Le montage', 'La pompe à vide et son instrument'] },
  ...
  },
  {
    ...
    groupesQ: ['G4'],
    lecons: [
      { t: 'Où fuit une installation', src: 'g4a', paras: 'tous', blocs: [0],
        visuels: ['svg:points-de-fuite', 'illu:g4a'],
        legendes: ['Six familles de points', 'L ordre ne s invente pas'] },
      { t: 'Consulter le registre avant de commencer', src: 'g4a', paras: 'tous', blocs: [1],
      ...
      { t: 'Méthode indirecte — mesurer et interpréter', src: 'g4b', paras: 'tous', blocs: [0, 1, 2],
        ...
        legendes: ['La lecture croisée', 'Pression et température, deux lectures'] },
      { t: 'Méthode directe — le détecteur', src: 'g4c', paras: 'tous', blocs: [0],
  ...
  },
  {
    ...
    lecons: [
      ...
      { t: 'Le support compte autant que le joint', src: 'g10', paras: 'tous', blocs: [1],
        visuels: ['svg:balayage-azote', 'illu:g10'],
        legendes: ['La sortie doit rester libre', 'La flamme sur l assemblage'] },
    ],
    activite: {
  ...
  /* =================== PARTIE F — RISQUE ET AVENIR =================== */
  {
    ...
    lecons: [
      ...
      { t: 'Ce qui fait consommer une installation', src: 'g11', paras: 'tous', blocs: [2],
